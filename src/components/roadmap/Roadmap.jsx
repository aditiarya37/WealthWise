...
const Roadmap = () => {
  ...
  const courses = [
    ...
    { title: "Suggestive Readings", unlocked: true, size: "large", link: "/content1", icon: <FontAwesomeIcon icon={faBookOpen} className="notes-icon" /> }, // Links to Content1.jsx
    ...
    { title: "Quiz", unlocked: true, size: "small", link: "/quiz1", icon: <FontAwesomeIcon icon={faQuestionCircle} className="quiz-icon" /> }, // Links to Quiz1.jsx
